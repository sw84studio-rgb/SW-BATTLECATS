...
const PONOS_KR='https://ponosgames.com/information/appli/battlecats/zukan/img/';
const TRAIT={
 '빨간 적':PONOS_KR+'zukan_target01_kr.png','떠있는 적':PONOS_KR+'zukan_target02_kr.png','검은 적':PONOS_KR+'zukan_target03_kr.png','천사':PONOS_KR+'zukan_target04_kr.png','에이리언':PONOS_KR+'zukan_target05_kr.png','메탈 적':PONOS_KR+'zukan_target06_kr.png',
 '좀비':PONOS_KR+'zukan_target07_kr.png','좀비 적':PONOS_KR+'zukan_target07_kr.png','고대종':PONOS_KR+'zukan_target08_kr.png','악마':PONOS_KR+'zukan_target09_kr.png','속성을 가지지 않은 적':PONOS_KR+'zukan_target10_kr.png','속성을 가지지 않는 적':PONOS_KR+'zukan_target10_kr.png',
 '사도':'e/9.png','마녀':'e/10.png','도장탑':'e/12.png','초수':'e/13.png','초생명체':'e/14.png','초현자':'e/15.png','괴인':'e/16.png'
};
const ABILITY={
...
function trait(label){const k=clean(label);const p=TRAIT[k];return p?{key:k,src:/^https?:\/\//.test(p)?p:ROOT+p}:null}
...
window.SWBattleCatsMarksV098={trait,ability,baseAbility,splitTraits,splitAbilityLines,splitResponses,traitMap:Object.freeze({...TRAIT}),abilityMap:Object.freeze({...ABILITY})};
})();
